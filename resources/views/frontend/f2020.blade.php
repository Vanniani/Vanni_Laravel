        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                <div class="d-flex justify-content-between p-3 bg-white mb-3 align-items-center"> <span class="font-weight-bold text-uppercase">Data Karyawan</span>
                    <div>
                      <form class="" action="/carif2020" method="GET">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-3 col-sm-6">
                    <div class="white-box">
                      ...
                      <img class="gambar" src="/image/{{ $fa->image }}" class="card-img-top">
                      </div>
                      <div class="product-bottom">
                        <div <span class="font-weight-bold">{{$fa->nama}}</span></div>
                        <div class="price">
                          <span class="font-weight-bold">{{$fa->nik}}
                        </div>
                        <div class="price">
                          <span class="font-weight-bold">{{$fa->alamat}}
                        </div>
                        <div class="price">
                          <span class="font-weight-bold">{{$fa->jabatan}}
                        </div>
                        <div class="price">
                          <span class="font-weight-bold">{{$fa->gaji}}
                        </div>
