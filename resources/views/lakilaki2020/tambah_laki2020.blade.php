...
@section('judul','Tambah Data Tahun 2020')

@section('isi')

<h1 class="mt-3">Tambah Data Tahun 2020</h1>

    <form method="post" action='/prosestambahdatalakitahun2020' enctype="multipart/form-data">
            @csrf
