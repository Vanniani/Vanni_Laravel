...
@section('judul','Tambah Data Tahun 2022')

@section('isi')

<h1 class="mt-3">Tambah Data Tahun 2022</h1>

    <form method="post" action='/prosestambahdatalakitahun2022' enctype="multipart/form-data">
            @csrf
